...
function _via_basic_demo_load_img() {
  ...
  var i, n;
  var file_count = 0;
  n = _via_demo_wikimedia_commons_featured_img_list.length;
  for ( i = 0; i < n; ++i ) {
    project_file_add_url(_via_demo_wikimedia_commons_featured_img_list[i]);
    file_count += 1;
  }
  _via_show_img(0);
  // update_img_fn_list();
...
var _via_basic_demo_img_filename = ['adutta_swan.jpg', 'two_img.jpg', 'third.jpg'];
...
// _via_reg_canvas.width = '1';
// _via_reg_canvas.height = '1';
// _via_reg_canvas.tabIndex = '1';
...
function image_grid_set_content_panel_height_fixed() {
  ...
  pc.style.height = (de.clientHeight - 5.5*57.359) + 'px';
}
